...
public class XmlParserTest {
    ...
    public void testStringOnly() {
        Component component = TextParsers.XML.parse("foo");
    ...
    public void testSpan() {
        Component component = TextParsers.XML.parse("<span>foo</span>");
    ...
    public void testAnchor() {
        Component component = TextParsers.XML.parse("<a href=\"bar\">foo</a>");
        TextComponent expected = TextComponent.of("").append(TextComponent.of("foo")
    ...
    public void testBold() {
        Component component = TextParsers.XML.parse("<b>foo</b>");
    ...
    public void testColor() {
        Component component = TextParsers.XML.parse("<color color=\"gray\">foo</color>");
    ...
    public void testInvalidColor() throws Exception {
        TextParsers.XML.parse("<color color=\"BestC0l0R\">foo</color>");
    }

    @Test
    public void testItalic() {
        Component component = TextParsers.XML.parse("<i>foo</i>");
    ...
    public void testObfuscated() {
        Component component = TextParsers.XML.parse("<obfuscated>foo</obfuscated>");
    ...
    public void testStrike() {
        Component component = TextParsers.XML.parse("<strike>foo</strike>");
    ...
    public void testUnderline() {
        Component component = TextParsers.XML.parse("<u>foo</u>");
    ...
    public void testHover() {
        Component component = TextParsers.XML.parse("<hover action=\"show_text\" value=\"bar\">foo</hover>");
        TextComponent expected = TextComponent.of("").append(TextComponent.of("foo")
    ...
    public void testInvalidHoverAction() throws Exception {
        TextParsers.XML.parse("<hover action=\"bar\" value=\"ay\">foo</hover>");
    }
    ...
    public void testInvalidClickAction() throws Exception {
        TextParsers.XML.parse("<click action=\"bar\" value=\"ay\">foo</click>");
    }

    @Test
    public void testTranslatable() {
        Component component = TextParsers.XML
            .parse("<tl key=\"chat.type.text\" with-1=\"SupaHam\" with-2=\"I'm the best!\">foo</tl>");
    ...
    public void testScore() {
        Component component = TextParsers.XML
            .parse("<score name=\"SupaHam\" objective=\"bar\" value=\"baz\">foo</score>");
    ...
    public void testSelector() {
        Component component = TextParsers.XML.parse("<selector pattern=\"SupaHam\" >foo</selector>");
