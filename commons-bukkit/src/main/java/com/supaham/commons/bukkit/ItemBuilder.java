...
public class ItemBuilder {
    ...
    /**
     * Sets the glint override on this item, making it glow as enchanted, without the enchantment label.
     *
     * @return this item builder instance, for chaining
     */
    ...
    /**
     * Sets whether this item is to glow using the glint override, making it glow as enchanted,
     ...
     * @return this item builder instance, for chaining
     */
    public ItemBuilder potionMain(PotionType effectType) {
        if (isPotionMeta()) {
            try {
                PotionMeta potionMeta = (PotionMeta) this.itemMeta;
                potionMeta.setBasePotionType(effectType);
            } catch (Exception e) {
                if (!this.failSilently) {
                    e.printStackTrace();
                }
