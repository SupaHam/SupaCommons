...
public class KillerLocationChecker extends WarnableLocationChecker<Player> {
  ...
  public KillerLocationChecker(@Nonnull Plugin plugin, @Nonnull Region region,
    ...
    this.returnSound = new SingleSound(org.bukkit.Sound.BLOCK_NOTE_BLOCK_PLING, 1F, 1.5F);
    this.outOfBoundsSound = new SingleSound(org.bukkit.Sound.BLOCK_NOTE_BLOCK_BASS, 1F, .5F);
  }
